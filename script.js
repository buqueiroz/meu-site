...
var home = document.querySelector('#one')
var home = document.querySelector('#two')
...
//   final alterar cor do header

// Scroll da pagina usando menu
...
links.forEach(link => {
  link.addEventListener('click', event => {
    ...
    section.scrollIntoView({
      behavior: 'smooth', // faz o scroll com animação suave
      block: 'start', // posiciona o topo da seção no topo da tela
    });
  });
});
// fim Scroll da pagina usando menu
